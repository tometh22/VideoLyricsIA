...
function openReview(renderParams) {
  let accepted = false;
  const job = {
  ...
  return render(<MemoryRouter initialEntries={["/review/resume-trial"]}><I18nProvider><AlertProvider><App /></AlertProvider></I18nProvider></MemoryRouter>);
}
