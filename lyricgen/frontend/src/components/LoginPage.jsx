    ...
    <div className="min-h-screen bg-surface flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-fade-in">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-gray-500">Plataforma de lyric videos con IA</p>
        </div>

        {/* Login card */}
        <div className="glass rounded-3xl p-8 shadow-glow">
          <h2 className="text-lg font-bold mb-1">Iniciar sesion</h2>
          <p className="text-xs text-gray-500 mb-6">Ingresa tus credenciales para continuar</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs text-gray-400 mb-1.5 ml-1">Usuario</label>
              <input
                type="text"
                value={username}
            ...
            <div>
              <label className="block text-xs text-gray-400 mb-1.5 ml-1">Contrasena</label>
              <input
                type="password"
                value={password}
        ...
        <p className="text-center text-[11px] text-gray-600 mt-8">
          GenLy AI Pro — Plataforma de generacion de lyric videos con inteligencia artificial
        </p>
      </div>
    </div>
  );
