...
export default function News() {
  const { t } = useI18n();
  const items = [
    { t: t("news.1_t"), d: t("news.1_d"), date: "May 2026", img: "/samples/sample-reef.png" },
    { t: t("news.2_t"), d: t("news.2_d"), date: "May 2026", img: null },
    { t: t("news.3_t"), d: t("news.3_d"), date: "Abr 2026", img: "/samples/sample-forest.png" },
  ];
