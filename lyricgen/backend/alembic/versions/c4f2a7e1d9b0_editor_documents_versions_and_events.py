...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("current_segments", postgresql.JSONB().with_variant(sa.JSON(), "sqlite"), nullable=False),
        sa.Column("original_segments", postgresql.JSONB().with_variant(sa.JSON(), "sqlite"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("segments", postgresql.JSONB().with_variant(sa.JSON(), "sqlite"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("properties", postgresql.JSONB().with_variant(sa.JSON(), "sqlite"), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
