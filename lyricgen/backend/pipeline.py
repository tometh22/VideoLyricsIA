...
def _gemini_cleanup_lyrics(audio_path: str, lrclib_plain: str,
    ...
    system_prompt = (
        ...
        "PRESERVE all sung vocalizations and ad-libs that appear in the "
        "audio (oh, uoh, ay, ah, eh, no no no, la la la, hey, mmm, etc.) "
        "— they are part of the lyric and MUST appear in the output as "
        "separate lines, in the same position they occur in the audio. "
        "This is especially important for outros/codas where rock and "
        "pop songs typically end with vocalizations not present in the "
