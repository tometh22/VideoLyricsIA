...
def test_old_processing_job_is_reaped_with_clear_message():
    ...
    try:
        ...
        # Assert the age-based per-row contract without relying on the global
        # sweep's advisory lock, which a daemon from an earlier lifespan test
        # may legitimately own in PostgreSQL CI.
